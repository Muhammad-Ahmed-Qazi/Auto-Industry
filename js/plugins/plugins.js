...
! function(a) {
    ...
    a.magnificPopup.registerModule(I, {
        options: {
            settings: null,
            cursor: "mfp-ajax-cur",
            tError: '<a href="https://muhammad-ahmed-qazi.github.io/Auto-Industry/%url%">The content</a> could not be loaded.'
        },
        proto: {
            initAjax: function() {
    ...
    a.magnificPopup.registerModule("image", {
        options: {
            ...
            titleSrc: "title",
            verticalFit: !0,
            tError: '<a href="https://muhammad-ahmed-qazi.github.io/Auto-Industry/%url%">The image</a> could not be loaded.'
        },
        proto: {
            initImage: function() {
                var c = b.st.image,
...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }(function(a) {
    ...
    a.magnificPopup.registerModule(I, {
        options: { settings: null, cursor: "mfp-ajax-cur", tError: '<a href="https://muhammad-ahmed-qazi.github.io/Auto-Industry/%url%">The content</a> could not be loaded.' },
        proto: {
    ...
    a.magnificPopup.registerModule("image", {
        options: { markup: '<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>', cursor: "mfp-zoom-out-cur", titleSrc: "title", verticalFit: !0, tError: '<a href="https://muhammad-ahmed-qazi.github.io/Auto-Industry/%url%">The image</a> could not be loaded.' },
        proto: {
            initImage: function() {
                var c = b.st.image,
                    d = ".image";
